...
{
    public class AccountController : Controller //kullanıcı hesap ve profil işlemleri için
    {
        // GET: Account
        ...
        public virtual async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (sonuc.Succeeded)
            {
                if (userManager.Users.Count() == 1)
                    ...
                    userManager.AddToRole(user.Id, IdentityRoles.Pasif.ToString());
        ...
        public async Task<ActionResult> RecoverPassword(string email)
        {
            ...
            {
                ViewBag.sonuc = "Bir hata oluştu. Tekrar deneyiniz";
                return View();
            }
        }
        ...
        public async Task<ActionResult> Activation(string code)
        {
            ...
            if (roleName == IdentityRoles.Pasif.ToString())
            {
                userManager.RemoveFromRole(sonuc.Id, IdentityRoles.Pasif.ToString());
                userManager.AddToRole(sonuc.Id, IdentityRoles.Kullanici.ToString());
            }
